...
{
// Changed by KLLAM @27-May-2023
// Some more info on https://www.nxp.com/docs/en/nxp/application-notes/AN133910.pdf page 51
...
/*  uint8_t command[] = {
  ...
  */
    uint8_t command[] = {
        PN532_COMMAND_TGINITASTARGET,
        //IPhone 1
        //0x00,                  // MODE: 0x04 = PICC only, 0x01 = Passive only (0x02 = DEP only)
        //IPhone 2
  ...
  /* Changed by KLLAM #27-May-2023 */
  // See https://stackoverflow.com/questions/59702411/pn532-emulated-card-not-read-by-an-android-phone
